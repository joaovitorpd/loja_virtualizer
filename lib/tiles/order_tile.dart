  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        //Como cada tile será responsável por apenas um documento, usa-se o DocumentSnapshot
        //pois ele atualiza apenas um documento
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot){
            if(!snapshot.hasData) {
              ...
              int status = snapshot.requireData["status"];
              ...
              return Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.0,),
                  Text(
                    _buidProductsText(snapshot.requireData)
                  ),
                  SizedBox(height: 4.0,),
                  Text(
                    "Status do Pedido:",
